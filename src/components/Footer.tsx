...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#010101] text-white pb-20 md:pb-0">
      ...
      <div className="relative z-10 w-full bg-[#010101]">
        <div className="flex w-full flex-col items-center gap-5 px-6 py-5 md:flex-row md:items-center md:justify-between md:gap-0 md:px-10 lg:px-16">
          {/* Copyright — left */}
          <p className="order-2 shrink-0 font-manrope text-[10px] font-semibold uppercase tracking-[0.2em] text-neutral-600 md:order-1">
          ...
          <div className="order-3 flex items-center gap-5">
            <Link
              ...
              aria-label="GitHub"
              className="flex items-center gap-1.5 text-neutral-500 transition-colors duration-200 hover:text-white"
            >
              <svg
              ...
              <span className="font-manrope text-[10px] font-semibold uppercase tracking-[0.2em]">
                GitHub
              </span>
            </Link>
