...
export default function Overview() {
  ...
  const [logosFetched, setLogosFetched] = useState(new Set());
  ...
  useEffect(() => {
    async function fetchMovieData(movieId) {
      try {
        ...
        setLogosFetched((prev) => new Set([...prev, movieId]));
      }
    }
                ...
                <div className="h-screen relative flex items-center">
                  ...
                  <div className="absolute z-30 inset-x-12 bottom-12 flex items-end justify-between">
                    <div className="space-y-5 max-w-2xl animate-[fadeInUp_0.8s_ease-out]">
                      {logos[item.id] ? (
                        <div className="mb-12 origin-bottom-left">
                          <img
                      ...
                      ) : !logosFetched.has(item.id) ? (
                        <div className="mb-12 h-36 w-80 rounded-lg animate-pulse bg-white/10" />
                      ) : (
                      ...
                      {data.results
                        ...
                        .map((nextItem) => (
                          <div
                            ...
                            className="group w-80 rounded-xl overflow-hidden cursor-pointer bg-[#141414] ring-1 ring-white/10 hover:ring-white/25 transition-all duration-300 shadow-2xl"
                          ...
                          >
                            ...
                            <div className="relative h-[3px] bg-white/10">
                              <div
                                ...
                                style={{ animation: "progressFill 15s linear forwards", width: "0%" }}
                              />
                            </div>
                            ...
                            <div className="relative aspect-video">
                              ...
                              />
                              <div className="absolute inset-0 bg-linear-to-t from-[#141414]/80 via-transparent to-transparent" />
                            ...
                            <div className="px-4 py-3">
                              <p className="text-white/35 text-[10px] uppercase tracking-[0.18em] font-semibold mb-1">
                                Up Next
                              </p>
                              ...
                              <div className="flex items-center gap-1.5 mt-1 text-xs text-white/40">
                                <span>{nextItem.release_date?.slice(0, 4)}</span>
                                <span>·</span>
                                <span className="text-[#46d369]">
                                  {Math.floor(nextItem.vote_average * 10)}% Match
                                </span>
                              </div>
                            </div>
                          </div>
                          ...
                          {Array.from({ length: totalPages }, (_, idx) => (
                            <button
                              ...
                              className={`rounded-full transition-all duration-300 ${
                                currentPage === idx
                                  ? "bg-white w-5 h-1.5"
                                  : "bg-white/25 w-1.5 h-1.5 hover:bg-white/50"
                              }`}
                            />
                          ))}
                        </div>
